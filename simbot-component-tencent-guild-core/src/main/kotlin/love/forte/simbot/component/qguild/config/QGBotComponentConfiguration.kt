...
public class QGBotComponentConfiguration {
    ...
    /**
     * 当 [QGBot] 或其他相关类型初始化内部信息时使用的配置
     *
     */
    public var initConfig: InitConfig = InitConfig()
}

/**
 * @see QGBotComponentConfiguration.initConfig
 */
public data class InitConfig(
    /**
     * 初始化并发相关配置
     */
    var parallel: ParallelConfig = ParallelConfig(),

) {
    public data class ParallelConfig(
        /**
         * 初始化频道服务器时的最大并发量。
         * 为1视为禁用并发, 为0视为无限制。
         *

...
class Ed25519TestsCommon {
    ...
    fun opcode13ProcessTest() = runTest {
        ...
        assertEquals("87befc99c42c651b3aac0278e71ada338433ae26fcb24307bdc5ad38c1adc2d01bcfc" +
                "adc0842edac85e85205028a1132afe09280305f13aa6909ffc2d652c706", result.verified.signature)
        assertEquals("Arq0D5A61EgUu4OxUvOp", result.verified.plainToken)
    }

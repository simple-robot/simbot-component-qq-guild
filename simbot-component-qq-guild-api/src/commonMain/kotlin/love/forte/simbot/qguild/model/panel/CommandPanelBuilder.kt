...
import love.forte.simbot.qguild.utils.toListIfNotEmpty
...
public class CommandPanelCreateBuilder {
     ...
     * 设置面板生效场景。
     */
    public fun scope(scope: String?): CommandPanelCreateBuilder = also {
        this.scope = scope
    }
    ...
    public fun build(): CommandPanelCreate = CommandPanelCreate(
        ...
        userOpenids = userOpenids.toListIfNotEmpty(),
        groupOpenids = groupOpenids.toListIfNotEmpty(),
        panel = panel,
    )
}

...
@Serializable
public data class QGContentText(public val content: String) : PlainText<QGContentText>, QGMessageElement<QGContentText> {
    ...
    override val key: Message.Key<QGContentText>
        get() = Key

    public companion object Key : Message.Key<QGContentText> {
        override fun safeCast(value: Any): QGContentText? = doSafeCast(value)
    }
}

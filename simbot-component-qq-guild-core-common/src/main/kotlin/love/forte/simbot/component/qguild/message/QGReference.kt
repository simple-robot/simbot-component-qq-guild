...
public class QGReference private constructor(
    ...
    override val key: SimbotMessage.Key<QGReference>
        get() = Key


    public companion object Key : SimbotMessage.Key<QGReference> {
        override fun safeCast(value: Any): QGReference? = doSafeCast(value)

...
private class QGAggregatedMessageReceiptImpl(private val messages: List<QGSingleMessageReceiptImpl>) : QGAggregatedMessageReceipt() {
...
internal fun Iterable<Message>.asReceipt(): QGAggregatedMessageReceipt = QGAggregatedMessageReceiptImpl(this.map { QGSingleMessageReceiptImpl(it) })

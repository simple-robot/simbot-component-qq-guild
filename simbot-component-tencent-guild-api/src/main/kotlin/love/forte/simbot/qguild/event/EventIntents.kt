...
public class Ready(override val s: Long, @SerialName("d") override val data: Data) : Signal.Dispatch() {
    /**
     * [Ready] 的事件内容
     */
    @Serializable
...
//
//        /** 当成员资料变更时 */
//        public object GuildMemberUpdate : GuildMembers<TencentMemberInfo>(
//            "GUILD_MEMBER_UPDATE",
//            TencentMemberInfo.serializer
//        )
//
//        /** 当成员被移除时 */

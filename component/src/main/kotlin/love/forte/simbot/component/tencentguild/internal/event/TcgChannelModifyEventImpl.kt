...
internal class TcgChannelCreate(
    ...
    override val after: TencentChannelImpl get() = source
    override val changedTime: Timestamp = Timestamp.now()
    override val timestamp: Timestamp get() = changedTime
    override val metadata: Event.Metadata = TcgChannelModifyMetadata(0, bot.id, source.id, changedTime)
...
internal class TcgChannelUpdate(
    ...
    override val changedTime: Timestamp = Timestamp.now()
    override val timestamp: Timestamp get() = changedTime
    override val metadata: Event.Metadata = TcgChannelModifyMetadata(1, bot.id, source.id, changedTime)
...
internal class TcgChannelDelete(
    ...
    override val changedTime: Timestamp = Timestamp.now()
    override val timestamp: Timestamp get() = changedTime
    override val metadata: Event.Metadata = TcgChannelModifyMetadata(2, bot.id, source.id, changedTime)
